                ...
                <ul class="nav">
                    <?php foreach ($menus as $k => $menu): ?>
                        ...
                        <?php if ($credentials): ?>
                            ...
                            <?php endif; ?>
                        <?php endif; ?>
                        <?php if ((is_array($menu)) && (!array_key_exists('dropdown', $menu))): ?>
                            <?php $name = $k; ?>
